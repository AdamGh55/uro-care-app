...
export default function DoctorMessages() {
    ...
    return (
        <div className="p-4 md:p-6 lg:p-8 h-[calc(100vh-64px)] lg:h-screen flex flex-col max-w-6xl mx-auto bg-muted/20">
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-muted-foreground ml-10">
                        {unreadCount > 0 ? `${unreadCount} conversations non lues` : 'Communiquez avec vos patients'}
                    </p>
                </div>
            </div>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center justify-between gap-2">
                                                ...
                                                <span className="text-xs text-muted-foreground whitespace-nowrap">
                                                    {new Date(thread.lastMessageTime).toLocaleTimeString('fr-FR', {
                                                        hour: 'numeric',
                                                        minute: '2-digit',
                                                    })}
                                                </span>
                            ...
                            <CardHeader className="border-b border-border pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    {selectedThread.unread && (
                                        <Badge variant="secondary">Nouveau message</Badge>
                                    )}
                                </div>
                            </CardHeader>
